...
<link rel="shortcut icon" href="http://www.520xx.cc/images/favicon.ico" type="image/x-icon"/>
<title><?php echo $SSNH['title']?></title>
<meta name="keywords" content="<?php echo $SSNH['keywords']?>">
<meta name="description" content="DeDeYun">
...
<body style="background-image: url(http://img0.ph.126.net/-SsBzfNSRK0Z34P1lacspA==/3298886727149211681.gif);background-attachment: fixed;background-repeat: no-repeat;background-size: cover;-moz-background-size: cover;">
<div class="container">
	<div class="header">
        <ul class="nav nav-pills pull-right" role="tablist">
          <li role="presentation" class="active"><a href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $SSNH["kfqq"]?>&site=qq&menu=yes">联系站长</a></li>
        </ul>
        <h3 class="text-muted" align="left" style="color:white;">一键生成整人网页</h3>
     </div>
	<hr>
	<div class="panel panel-primary" style="margin:1% 1% 1% 1%;background: rgba(255, 251, 251, 0.7)">
                <div class="panel-heading bk-bg-primary">
                    <h6><span class="panel-title">生成整人弹框网页</span></h6>
                </div>
        ...
        <input id="search_input" type="text" style="background: rgba(255, 251, 251, 0.7)" class="form-control" name="name" placeholder="可随意输入"/></div></p>
          <div class="input-group">
           <span class="input-group-addon">&nbsp;地&nbsp;&nbsp;&nbsp;址:</span>
        <input id="search_input" type="text" style="background: rgba(255, 251, 251, 0.7)" class="form-control" value="<?php echo $SSNH['msg']?>"/></div></p>
      	<input id="search_button" value="一键生成" type="submit" class="btn btn-primary btn-block"/></form>
...
<div class="panel panel-primary" style="margin:1% 1% 1% 1%;background: rgba(255, 251, 251, 0.7)">
<div class="panel-body">
 <div class="alert alert-info" role="alert"><span class="glyphicon glyphicon-info-sign"></span> <strong>提示</strong>:对应输入内容  点击对应的按钮即可。</div>
<div class="alert alert-warning" role="alert"> <i class="glyphicon glyphicon-bullhorn"></i> <strong>公告</strong>:有问题/错误/BUG/等请联系本站客服~</div>
<div class="alert alert-danger" role="alert"> <i class="glyphicon glyphicon-bullhorn"></i> <strong>公告</strong>:默笙源码交流群:<a href="http://www.520xx.cc" class="alert-link">484395502</a> 欢迎大家加入。</div>
</p></div>

				<hr><div class="container-fluid">
  <a href="<?php echo $SSNH['qun']?>" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-credit-card"></span> 加群</a>
  ...
  <a href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $SSNH["kfqq"]?>&site=qq&menu=yes" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-pencil"></span> 反馈</a>
</div>
<p style="text-align:center"><br>CopyRight &copy; 2017 Powered by <a href="/">默笙 www.tecms.net</a></p></div>
</body>
</html>