...
<div class="wrap">
	<div class="HccToolsMenu">
		<ul>
			...
			<li><a href="http://libs.hechaocheng.tk/">导航-3</a></li>
			<li><a href="http://css.hechaocheng.tk/">导航-4</a></li>
			<li><a href="http://fonts.hechaocheng.tk/">导航-5</a></li>
		</ul>
		
		<div style="float:right">
			<a href="//bbs.blsun.net/" target="_blank">社区讨论</a>
		</div>
	</div>
	...
	<div class="HccTools">
		...
		<div class="HccTools1" style="text-align:center;">
			...
			<?php }?>
				...
				<div class="HCC_Info"><?php echo $Tools_config['des'];?></div>
				<div style=""><a href="///" target="_blank">站长社区</a>&nbsp;<a href="http://www.hechaocheng.tk/" target="_blank">前端公共库</a>&nbsp;<a href="" target="_blank"></a>&nbsp;</div>
				
				&copy;Copyright <a href="//<?php echo ToolsUrl;?>" style="color:#000"><?php echo ToolsUrl;?></a> All Rights Reserved.<br /><a onClick="if(confirm('提示：有\'发广告,睹博,加另一个Q(皮条客),招网络刷单,裸聊,刷单…\'等行为的朋友请勿加群,否则一经发现,直接请出去.')){return true;}else{return false;};" href="http://shang.qq.com/wpa/qunwpa?idkey=cffe2a2cd11a784ad710b879ae697e68dc6a5d599ba21baaa5dbc76779965d23" target="_blank" style="color:#999999">Q群讨论(23189103)</a>
				<a href="http://hechaocheng.cn/" target="_blank" style="color:#999" title="阿城守候">Hechaocheng</a>
			</div>
		</div>
</div>
