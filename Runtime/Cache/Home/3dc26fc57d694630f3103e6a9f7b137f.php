  ...
  <div class="container centent" style="padding-bottom:20px;">
    ...
    <footer class="footer text-center">
      ...
      <div class="footer text-center">
        <!--这里可以放统计代码-->
        欢迎来自：<?php echo ($weather["lives"]["0"]["province"]); echo ($weather["lives"]["0"]["city"]); ?>IP为—<?php echo ($ip); ?>的网友,当前天气为：<?php echo ($weather["lives"]["0"]["weather"]); ?>,温度：<?php echo ($weather["lives"]["0"]["temperature"]); ?>℃,风向：<?php echo ($weather["lives"]["0"]["winddirection"]); ?>,更新时间：<?php echo ($weather["lives"]["0"]["reporttime"]); ?>
      </div>
      <div id="f_list">
